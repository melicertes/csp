...
* Original source from https://bitbucket.org/raphaelm/django-formset-js
*
* MWE: Extended with a prefixPlaceholder option to support nested formsets
*/
(function($) {
    "use strict";
    ...
    */
    ...
    Formset.prototype.addForm = function() {
        ...
        var newFormHtml = this.$emptyForm.html()
            .replace(new RegExp(this.opts.prefixPlaceholder, 'g'), newIndex)

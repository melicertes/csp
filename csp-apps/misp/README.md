...
cp misp-server-0.4.2-SNAPSHOT-exec.jar misp-server-0.4.2-SNAPSHOT-exec_201801301614.jar
### override current jar in use
cp /tmp/boulougaris/misp-adapter-emitter-0.4.2-SNAPSHOT-exec.jar misp-server-0.4.2-SNAPSHOT-exec.jar

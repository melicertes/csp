...
#*.demo1-csp.athens.intrasoft-intl.private
...
## ON LINUX
# curl -v -s -k --key ./csp-external.key --cert ./csp-external.crt https://es.demo1-csp.intrasoft-intl.com https://localhost
...
#*.local.demo1-csp.athens.intrasoft-intl.private
## We're self signing our own server cert here.  This is a no-no in production.
...
## ON LINUX
# curl -v -s -k --key ./csp-internal.key --cert ./csp-internal.crt https://es.local.demo1-csp.intrasoft-intl.com https://localhost

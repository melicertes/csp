...
function downloadCSPImage() {
	...
	local r=$(( $? ))
	curl --progress-bar -o /opt/csp/il/integration-tests-3.6.0-SNAPSHOT.jar http://central.preprod.melicertes.eu/repo-loads/integration-layer/integration-tests-3.6.0-SNAPSHOT.jar
	r=$(( $r + $? ))
